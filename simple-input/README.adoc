...
Select `CommandProcess` from the side bar.
...
A new window will appear next to the `CommandProcess` one, simply listing the content as you enter it into the Input Main.
